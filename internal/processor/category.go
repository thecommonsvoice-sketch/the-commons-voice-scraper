	...
	categoryKeywords := []struct {
		...
		},
		{
			...
			[]string{"international", "foreign", "global", "world", "china", "russia",
				...
				"taiwan", "syria", "myanmar", "afghanistan", "pakistan", "bangladesh",
				"sri lanka", "nepal", "vietnam", "thailand", "indonesia", "philippines",
				"brazil", "mexico", "turkey", "saudi arabia", "uae", "qatar", "egypt",
				"nigeria", "kenya", "south africa", "ethiopia", "switzerland", "sweden",
				"norway", "denmark", "netherlands", "spain", "italy", "poland", "greece",
